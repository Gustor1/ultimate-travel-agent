...
- **Feasibility:** test chronology, opening windows, connection/check-in buffers, geography, walking/energy limits, meals/rest, night safety, accessibility, lodging nights, and fallback compatibility. Audit food/photo detours against the actual route and light/meal windows.
...
- Reject `recommendation_ready` without coverage, evidence, artifacts, and comparable options. Do not present provisional flight windows or unpriced air travel as a bookable trip. Record machine-check results.
